...
{
    SCE_CMaterial *mat;  /**< Core material */
...
void SCE_Material_SetPointSpriteModel (SCE_SMaterial*, SCE_CPointSprite*);
/* renvoie le modele de point sprite */
SCE_CPointSprite* SCE_Material_GetPointSpriteModel (SCE_SMaterial*);
