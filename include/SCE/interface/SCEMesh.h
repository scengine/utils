...
enum sce_emeshrendermode {
    SCE_UNIFIED_VBO_RENDER_MODE = SCE_UNIFIED_VAO_RENDER_MODE + 42;
};
typedef enum sce_emeshrendermode SCE_EMeshRenderMode;
...
int SCE_Mesh_MakeFrom (SCE_SMesh*, SCE_SGeometry*);

int SCE_Mesh_Build (SCE_SMesh*, SCE_EMeshBuildMode, SCE_EMeshRenderMode);
