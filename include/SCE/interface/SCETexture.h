...
struct sce_stexture
{
    SCE_CFramebuffer *fb[6]; /**< Integrated frame buffers (6 for cubemaps) */
    SCE_CTexture *tex;       /**< Core texture */
...
/* quitte le gestionnaire de textures */
...
/* permet de definir un parametre a une texture */
void SCE_Texture_SetParam (SCE_STexture*, SCEenum, SCEint);
void SCE_Texture_SetParamf (SCE_STexture*, SCEenum, SCEfloat);
...
/* force certaines valeurs (voir SCECTexture.c) */
